...
pu_data <- suppressWarnings(as(read_sf("data/pu.shp"), "Spatial"))
...
veg_data <- suppressWarnings(stack("data/vegetation.tif"))

# verify that data are in same coordinate reference system

# manually set the coordinate reference system for veg_data to be equal to
# the coordinate reference system for pu_data,
## note that we do this because we know that the data have the same
## projection system, and normally you use would sp::spTransform or
