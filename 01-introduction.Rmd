...
```{r, eval = FALSE}
install.packages(
  c("sf", "dplyr", "sp", "rgeos", "rgdal", "raster", "units", "prioritizr",
    "prioritizrdata", "mapview", "assertthat", "remotes", "gridExtra",
    "BiocManager"),
  type = "binary")
