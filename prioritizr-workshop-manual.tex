...
You will need to have both R and RStudio installed on your computer to
...
Finally, you will also need to download the data for this workshop.
...
\href{https://github.com/prioritizr/massey-workshop/raw/master/data.zip}{download
it from here}. After downloading the data, you can unzip the data into a
new folder. Next, you will need to set the working directory to this new
folder. To achieve this, click on the \emph{Session} button on the
RStudio menu bar, then click \emph{Set Working Directory}, and then
\emph{Choose Directory}.
...
## [19] parallel_4.0.0      yaml_2.2.1          xfun_0.16          
...
## [34] rmarkdown_2.3       bookdown_0.20.2     purrr_0.3.4        
